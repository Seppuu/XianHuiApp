...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/BKPasscodeView/BKPasscodeView.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/LTInfiniteScrollView-Swift/LTInfiniteScrollView_Swift.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/Palau/Palau.framework"

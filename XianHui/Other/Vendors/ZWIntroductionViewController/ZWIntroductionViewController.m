...
- (void)viewDidLoad {
    ...
    self.pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:214/255.0 green:214/255.0 blue:214/255.0 alpha:1.0];
    [self.view addSubview:self.pageControl];
    
    if (!self.enterButton) {
        self.enterButton = [UIButton new];
        [self.enterButton setTitle:@"开始" forState:UIControlStateNormal];
        [self.enterButton setTitleColor:[UIColor colorWithRed:20/255.0 green:128/255.0 blue:226/255.0 alpha:1.0] forState:UIControlStateNormal];

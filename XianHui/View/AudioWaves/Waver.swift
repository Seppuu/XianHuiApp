...
class Waver: UIView {
    ...
    func compressSamples() -> [Float]? {
        ...
        print("Samples before compress \(waveSamples)")
        ...
        print("Bubble Width is \(bubbleWidth) effectiveSample \(effectiveSample)")
        ...
        print("😄 samplesCount \(samplesCount) totalTime \(totalTime) bubbleWidth \(bubbleWidth) effectiveSample \(effectiveSample) sampleGap \(sampleGap) timePerSample \(timePerSample)")
        ...
        print("Final Sample is \(finalSamples)")
